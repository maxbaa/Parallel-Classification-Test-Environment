...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run one benchmark config with a filtered runtime-specific algorithm set.")
...
def main() -> None:
    ...
    command = [sys.executable, "-m", "pcte_cli", "--config", str(output_path)]
